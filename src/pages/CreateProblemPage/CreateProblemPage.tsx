      ...
      const newQuestion: Omit<Question, "id" | "order"> = {
        ...
        selectionMode:
          form.answerType === "multiple-choice"
            ...
            : undefined,
        options:
          form.answerType === "multiple-choice" ? form.options : undefined,
      ...
      <div className={styles.formContainer}>
        ...
        {form.answerType === "multiple-choice" && (
          <div className={styles.section}>
            ...
            <div className={styles.radioGroup}>
              <label className={styles.radioLabel}>
                <input
                  ...
                  onChange={(e) =>
                    updateForm("selectionMode", e.target.value as SelectionMode)
                  }
                />
                <span>단일 선택</span>
              </label>
            ...
            <div className={styles.optionsContainer}>
              ...
              {errors.options && (
                <div className={styles.errorMessage}>{errors.options}</div>
              )}
                  ...
                  {form.options.map((option) => (
                    <label key={option.id} className={styles.radioLabel}>
                      <input
                        ...
                        onChange={(e) =>
                          updateForm("correctAnswer", [e.target.value])
                        }
                      />
                      <span>
        ...
        {form.answerType === "subjective" && (
          <div className={styles.section}>
            ...
            <TextInput
              label="정답"
              value={form.correctAnswer.length > 0 ? form.correctAnswer[0] : ""}
              onChange={(value) =>
